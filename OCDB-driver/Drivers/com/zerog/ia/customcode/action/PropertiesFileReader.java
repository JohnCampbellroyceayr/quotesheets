/* -*-tab-width: 4; -*-
 *
 * PropertiesFileReaded.java 6/02/2003
 *
		...
		while(keys.hasMoreElements())
		{
			...
			if(ignoreProperties.indexOf(key) == -1)
			{
				...
				if(substituteVariables.equalsIgnoreCase("true"))
				{
					...
					//else
					//{	
					//	System.err.println("I did nothing");				
					//}
				}
			...
			//else
			//{
			//	System.err.println("ignoreProperties.indexOf(key):  "+ignoreProperties.indexOf(key));
			//}
			
			System.err.println("Setting $"+key+"$ to "+value);
			System.err.println("Verifying...");
			System.err.println("ip.getVariable($"+key+"$): "+ ip.getVariable("$"+key+"$"));		
		}
	}
